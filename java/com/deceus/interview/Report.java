...
public class RunReport {
   ...
   private void buildDocument() {
      ...
      String text = "This is the first cell, in the first row";
      cell.setText(text);
      ...
      // The above needs to be ran for every cell in our row and there will be many
      // rows with many cells. How would you handle this?
      /*
       * 
       * ------Your code here-----
       * 
      ...
      // The fontSize and fontName do not change throughout the report, how would you
      // change the code above now that you are given this information?
   }
